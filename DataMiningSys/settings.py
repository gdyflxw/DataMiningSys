"""
Django settings for DataMiningSys project.
...
SECRET_KEY = 'a6-w!#cd25(=m!vrgg3hkvh1ut_h+_q&g=4!c($g+&!nn!kryq'
...
WSGI_APPLICATION = 'DataMiningSys.wsgi.application'
...
SESSION_SAVE_EVERY_REQUEST = True  # 是否刷新Session